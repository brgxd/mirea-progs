include("lib.jl")
function count_border_horiz_12!(r,side)::Int64
...
function count_borders_horiz_12!(r,side)::Int64
    x = 0
    while !isborder(r,HorizonSide(side))
        if isborder(r,HorizonSide(2))
            x += count_border_horiz_12!(r,side)
        end
        trymove!(r,side)
    end
    return x
...
function num12!(r)
    ...
    county!(r)
    while !isborder(r,HorizonSide(2))
        total_borders += count_borders_horiz_12!(r,side)
